...
namespace Game.Grid
{
    ...
    public class GridContainer<T>
    {
        ...
        // CONSTRUCTOR
        // ----------------------------------------------------------
        public GridContainer(int _width, int _height, Vector2 _cellSize, Vector2 _cellSpacing, Vector2 _origin, Func<T> _defaultValue, Anchor _anchor = Anchor.Center)
        {
            width = _width;
            height = _height;
            cellSize = _cellSize;
        ...
        // GRID HELPERS
        // ----------------------------------------------------------
        public bool IsInsideGrid(int _x, int _y) => _x >= 0 && _y >= 0 && _x < width && _y < height;
        ...
        public void SetValue(Vector2Int _cell, T _value) => SetValue(_cell.x, _cell.y, _value);
        ...
        /// <summary>
        /// Returns world position of a cellÅfs **center**.
        /// </summary>
